...
public final class ErrorCode {
    ...
    public static final String TAG_ID_INCORRECT = "00002";
    ...
    public static final String GIFT_CERTIFICATE_ID_INCORRECT = "00006";
    ...
    public static final String GIFT_CERTIFICATE_DATES_INCORRECT = "00011";
